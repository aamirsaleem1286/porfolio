        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I am a professional and well trained web developer with 2 year experience.
            <p className="home-about-body">
              ...
              <i>
                <b className="purple"> reactjs , Javascript,nodejs  . </b>
              </i>
              <br />
              <br />
              My field of Interest's are building new websites
              <i>
              </i>
              <br />
              <br />
